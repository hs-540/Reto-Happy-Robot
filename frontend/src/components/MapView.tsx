...
/* Iconos: cada tipo tiene una silueta distinta al primer vistazo, no solo un
   color. En un mapa a 4 minutos de demo, dos formas parecidas son un fallo. */
const ICONS: Record<string, string> = {
  ...
  /** rayo: nodo de red */
  subestacion: '<path d="M13 1 3 14h7l-1 9 10-13h-7l1-9z" fill="currentColor"/>',
  /** mástil con ondas de señal */
  torre:
  ...
  // ─ recursos ─
  /** casco de obra: cuadrilla humana */
  brigada:
  ...
  /** grupo electrógeno: caja con enchufe */
  generador:
  ...
  /** camión cisterna: cabina + depósito cilíndrico */
  cisterna:
